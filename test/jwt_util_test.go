...
func TestParseBearerToken(t *testing.T) {
	bearerAgentToken := "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE2NjQ1MTQzNjMsImlhdCI6MTY2NDQyNzk2MywiYXBwSWQiOiJ3ZWl4aW4ifQ.dZguQfDel-OTG1LhakVJ6FfY2kZ5MgkhWGUk5A9kLYI"
	agentToken := util.ParseBearerToken(bearerAgentToken)
	fmt.Print("agentToken:" + agentToken + "\n")
}
